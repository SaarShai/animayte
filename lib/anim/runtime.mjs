...
export async function createRuntime(canvas, opts = {}) {
  ...
  function drawPet(dt) {
    ...
    // personality scales how BIG a reaction reads (deviation from rest × intensity)
    const k = cur.kind === 'reaction' ? intensity : 1;
  ...
  return {
    setMood, setFullness, addBird, removeBird, clearBirds, relief, sleep, wake, reset, reactByName, toIdle,
